...
public class PatchActualizarEmpresaCompleto implements Task {
    private String id;
    private GestionEmpresaData gestionEmpresaData;

    public PatchActualizarEmpresaCompleto(String id, GestionEmpresaData gestionEmpresaData) {
        this.id = id;
    ...
    public static PatchActualizarEmpresaCompleto conDatos(String id, GestionEmpresaData gestionEmpresaData) {
        return Tasks.instrumented(PatchActualizarEmpresaCompleto.class, id, gestionEmpresaData);
    }
}
