...
public class ClickearBotonCrearComercilizador implements Task {
    public static ClickearBotonCrearComercilizador crearComercializador() {
        return Tasks.instrumented(ClickearBotonCrearComercilizador.class);
    }

    @Override
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(Click.on(ContenedorDeObjetosGestionarComercializador.BTN_CREAR_COMERCIALIZADOR));
    }
}
