...
public class ValidarLimpiarCampoNit implements Question {
    public static ValidarLimpiarCampoNit limpiarCamposNitDeFiltro() {
        return new ValidarLimpiarCampoNit();
    }
    @Override
    public Object answeredBy(Actor actor) {
        return Text.of(ContenedorDeObjetosGrupoEmpresarial.VALIDAR_CAMPO_NIT_VACIO).answeredBy(actor);
    }
